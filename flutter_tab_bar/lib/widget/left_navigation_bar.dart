...
/*
* 重写了BottomNavigationBar
* 1.删除了所有注释
* 2.修改了Widget、State名称
* 3.移除_Bar的子视图ConstrainedBox、Material中的Padding以及additionalBottomPadding
* 4.移除了图层树中MediaQuery.removePadding
* 5.修改DefaultTextStyle.merge子视图从Row=>Column，并修改了主轴方向center=>start
* 6._Tile中加了Center用来居中
* 7.添加了isSpaceEvenly属性用来设置item高度
* */
  ...
  List<Widget> _createTiles(BottomNavigationBarLandscapeLayout layout) {
    ...
    for (int i = 0; i < widget.items.length; i++) {
      ...
      tiles.add(_BottomNavigationTile(
        ...
        layout: layout,
        isSpaceEvenly: widget.isSpaceEvenly,
      ));
    }
    return tiles;
  }
...
class _Circle {
  ...
  final _LeftNavigationBarState state;
  final int index;
  final Color color;
